...
#Solicitar la carga de dos valores y nos muestre la suma. Mostrar finalmente un mensaje de despedida del programa.
#Implementar las actividades en tres funciones.
